...
public class SimopuveRESTServices {
    ...
    private final HashMap<String, PDVHeader> logins = new HashMap<String, PDVHeader>() {
        ...
        put("franco.krizanic.movi:sgtp2513", new PDVHeader("MOVISTAR VIÑA DEL MAR", "LIBERTAD 1122, LOCAL F", "VIÑA DEL MAR", 0, 0, 0, new Date(), "Franco Krizanic", 0,false));*/
            ...
            put("cesar.gonzales.cla:zrq3we7B", new PDVHeader("CLARO AHUMADA", "Ahumada 87", "SANTIAGO", 0, 0, 0, new Date(), "Cesar Gonzales", 0, false));
            put("sebastian.prado.movh:npCnXlcc", new PDVHeader("TMM Ahumada", "Ahumada  N° 97 - SANTIAGO", "SANTIAGO", 0, 0, 0, new Date(), "Sebastian Prado", 0, false));
            put("sebastian.prado.enth:YFpzZ78x", new PDVHeader("ENTEL AHUMADA", "Ahumada 215 - SANTIAGO", "SANTIAGO", 0, 0, 0, new Date(), "Sebastian Prado", 0, false));
            ...
            put("maria.d:9715ZLmq", new PDVHeader("TALCA TMM ","8 Oriente 1142","TALCA" ,0, 0, 0, new Date(), "Maria Duran ", 0, false));    
            ...
            put("gladys.h:4137kpqw", new PDVHeader("ENTEL CONCEPCION","Barros 541","CONCEPCION" ,0, 0, 0, new Date(), "Gladys Herrera", 0, false));            
            put("pablo.g:1871Axed", new PDVHeader("MOVISTAR CONCEPCION","O\'Higgins N 674","CONCEPCION" ,0, 0, 0, new Date(), "Pablo Gonzalez", 0, false));
            put("macarena.a:5620LseT", new PDVHeader("Wom CONCEPCION","Barros 689","CONCEPCION" ,0, 0, 0, new Date(), "Macarena Araneda", 0, false));
            put("rosa.v:7527xEZf", new PDVHeader("CLARO PUERTO MONTT","Talca N 141","PUERTO MONTT" ,0, 0, 0, new Date(), "Rosa Venegas", 0, false));
            put("claudio.m:5098UAKt", new PDVHeader("ENTEL PUERTO MONTT","Varas N 515","PUERTO MONTT" ,0, 0, 0, new Date(), "Claudio Manzanarez", 0, false));
            put("maria.m:3612ZJjv", new PDVHeader("Wom PUERTO MONTT","Guillermo Gallardo N 170","PUERTO MONTT" ,0, 0, 0, new Date(), "Maria Marquez", 0, false));
            put("nicolas.m:7337NhMR", new PDVHeader("TMM PUERTO MONTT","PEDRO MONTT 120","PUERTO MONTT" ,0, 0, 0, new Date(), "Nicolas Mansanarez", 0, false));
